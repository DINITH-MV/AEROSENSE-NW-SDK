...
def launch_setup(context, *args, **kwargs):
    ...
    try:
        from aerosense_mavros.dji_interface import discover_all_drones
    except ImportError:
        # Try relative import if we are in the source tree
        current_dir = os.path.dirname(__file__)
        # Go up to aerosense_mavros package root
        ...
        try:
            ...
            print("Could not import aerosense_mavros.dji_interface.")
            return []
