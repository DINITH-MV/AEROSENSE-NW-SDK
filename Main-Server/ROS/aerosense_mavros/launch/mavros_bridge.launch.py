"""
AeroSense MAVROS Bridge Launch File

Launch the MAVROS-compatible interface for AeroSense DJI drone control.
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='IP address of the DJI remote controller running AeroSense'
        ),
        DeclareLaunchArgument(
            'namespace',
            default_value='',
