#!/bin/bash
# Auto-discovery launch script for AeroSense MAVROS Bridge
...
NAMESPACE=$(python3 -c "
import sys
sys.path.insert(0, '/ros2_ws/install/aerosense_mavros/lib/python3.10/site-packages')
from aerosense_mavros.dji_interface import discover_drone
...
exec ros2 run aerosense_mavros mavros_bridge --ros-args -r __ns:=/$NAMESPACE
