...
from aerosense_mavros.dji_interface import discover_all_drones, get_config
from aerosense_mavros.mavros_bridge import AeroSenseMavrosNode


def main(args=None):
    """Main entry point with auto-discovery and dynamic namespace."""
    
    print("AeroSense MAVROS Bridge - Auto-Discovery Mode")
    print("=" * 60)
