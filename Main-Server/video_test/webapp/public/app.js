...
const videoChartDefinitions = [
  ...
  {
    key: "jitterBufferDelayMs",
    title: "Receiver Jitter Delay",
    unit: "ms/frame",
  },
  ...
  {
    key: "inboundFramesInError",
    title: "MediaMTX Frame Errors",
    unit: "frames",
  },
];
...
const chartGroups = {
  ...
  telemetryCharts: {
    grid: telemetryChartsGrid,
    definitions: telemetryChartDefinitions,
  },
};
  ...
  [
    ...
    [
      [
        ...
        "/send/takeoff",
        "",
        "Requests DJI takeoff. The aircraft arms as part of the DJI takeoff flow.",
      ],
      [
        "Land",
        "POST",
        "/send/land",
        "",
        "Requests immediate landing from the current position.",
      ],
      [
        "Return To Home",
        "POST",
        "/send/RTH",
        "",
        "Starts DJI return-to-home using the currently configured home point and RTH altitude.",
      ],
      [
        "Goto Altitude",
        "POST",
        "/send/gotoAltitude",
        "35",
        "Commands a target altitude in meters while keeping the current horizontal position.",
      ],
      [
        "Goto Yaw",
        "POST",
        "/send/gotoYaw",
        "180",
        "Commands an absolute aircraft heading in degrees.",
      ],
      [
        "Set RTH Altitude",
        "POST",
        "/send/setRTHAltitude",
        "60",
        "Updates the DJI return-to-home altitude in meters before an RTH command is needed.",
      ],
    ],
  ],
  [
    "HTTP Virtual Stick",
    "Manual-control style inputs and interruption commands. Virtual stick must be enabled before velocity-like control is useful, and stick values are normalized rather than physical units.",
    [
      [
        ...
        "",
        "Enables DJI virtual stick mode so subsequent stick commands are accepted.",
      ],
      [
        "Stick Command",
        "POST",
        "/send/stick",
        "0.0,0.2,0.0,-0.1",
        "Sends leftX,leftY,rightX,rightY normalized stick values. Typical range is -1.0 to 1.0.",
      ],
      [
        "Abort Mission",
        "POST",
        "/send/abortMission",
        "",
        "Stops the current mission flow, zeros stick input, and disables virtual stick where supported.",
      ],
      [
        "Abort All",
        "POST",
        "/send/abortAll",
        "",
        "Broad cancellation path for queued or active mission activity.",
      ],
      [
        ...
        "",
        "Returns control to autonomous command handling after manual override has been active.",
      ],
    ],
  ],
  [
    "HTTP Camera And Gimbal",
    "Payload commands routed through the phone to DJI camera/gimbal APIs. These are useful for operator payload checks independently of navigation.",
    [
      [
        "Gimbal Pitch Move",
        "POST",
        "/send/gimbal/pitch",
        "0,-20,0",
        "Sends an absolute roll,pitch,yaw command; this route is normally used for pitch.",
      ],
      [
        "Gimbal Yaw Move",
        "POST",
        "/send/gimbal/yaw",
        "0,0,45",
        "Sends an absolute roll,pitch,yaw command; this route is normally used for yaw.",
      ],
      [
        "Camera Zoom",
        "POST",
        "/send/camera/zoom",
        "2.0",
        "Sets the camera zoom ratio directly, subject to the aircraft/camera zoom limits.",
      ],
      [
        "Start Recording",
        "POST",
        ...
        "",
        "Starts camera recording on the aircraft payload.",
      ],
      [
        "Stop Recording",
        "POST",
        ...
        "",
        "Stops camera recording on the aircraft payload.",
      ],
    ],
  ],
  [
    "HTTP Waypoint And Mission",
    "Higher-level navigation routes for single-waypoint and multi-waypoint movement. These commands carry coordinates in the request body, so check units before publishing from scripts.",
    [
      [
        "Goto Waypoint",
        "POST",
        "/send/gotoWP",
        "55.6761,12.5683,35",
        "Single lat,lon,alt waypoint command in decimal degrees and meters.",
      ],
      [
        "Goto Waypoint With PID",
        "POST",
        "/send/gotoWPwithPID",
        "55.6761,12.5683,35,90,4",
        "Waypoint plus yaw and maxSpeed: lat,lon,alt,yaw,maxSpeed.",
      ],
      [
        "Navigate Trajectory",
        "POST",
        "/send/navigateTrajectory",
        "55.6761,12.5683,25;55.6764,12.5688,30;55.6768,12.5692,32,90",
        "Semicolon-separated waypoint list; final waypoint may include yaw.",
      ],
      [
        "Navigate DJI Native",
        "POST",
        "/send/navigateTrajectoryDJINative",
        "4.0;55.6761,12.5683,25;55.6768,12.5692,32",
        "DJI native mission upload with speed first, then at least two lat,lon,alt waypoints.",
      ],
      [
        "Abort DJI Mission",
        "POST",
        ...
        "",
        "Stops the active DJI native mission path.",
      ],
    ],
  ],
  [
    "HTTP Sensing And Status",
    "Read/control endpoints for operator state, AutoSensing, and phone-side configuration. These are useful for checking what the app believes before sending motion commands.",
    [
      [
        "Start AutoSensing",
        "POST",
        ...
        "",
        "Enables AutoSensing on the device.",
      ],
      [
        "Stop AutoSensing",
        "POST",
        ...
        "",
        "Disables AutoSensing on the device.",
      ],
      [
        ...
        "",
        "Returns whether manual override is currently active.",
      ],
      [
        "AutoSensing Status",
        "POST",
        ...
        "",
        "Returns AutoSensing enablement and target count.",
      ],
      [
        "AutoSensing Targets",
        "POST",
        ...
        "",
        "Returns the current detected target array from the phone app.",
      ],
      [
        "Config",
        "GET",
        "/config",
        "",
        "Reads IP, drone name, and port configuration from the phone app.",
      ],
    ],
  ],
];
...
const rosPublishCatalog = [
  [
    ...
    [
      [
        ...
        "ros2 service call /DRONE_NS/mavros/cmd/takeoff std_srvs/srv/Trigger {}",
        "Requests DJI takeoff through the MAVROS-compatible bridge.",
      ],
      [
        "Land",
        "service",
        "/mavros/cmd/land",
        "std_srvs/srv/Trigger",
        "ros2 service call /DRONE_NS/mavros/cmd/land std_srvs/srv/Trigger {}",
        "Requests landing through the bridge.",
      ],
      [
        "Return To Launch",
        "service",
        "/mavros/cmd/rtl",
        "std_srvs/srv/Trigger",
        "ros2 service call /DRONE_NS/mavros/cmd/rtl std_srvs/srv/Trigger {}",
        "Requests DJI return-to-home through a MAVROS-style RTL route.",
      ],
      [
        "Arming Compatibility",
        "service",
        "/mavros/cmd/arming",
        "std_srvs/srv/SetBool",
        'ros2 service call /DRONE_NS/mavros/cmd/arming std_srvs/srv/SetBool "{data: true}"',
        "Compatibility route. DJI aircraft effectively arm on takeoff; false maps to landing.",
      ],
      [
        "Enable Offboard",
        "service",
        ...
        "std_srvs/srv/Trigger",
        "ros2 service call /DRONE_NS/mavros/set_mode/offboard std_srvs/srv/Trigger {}",
        "Enables virtual stick/offboard-style control before velocity setpoints.",
      ],
      [
        "Abort Mission",
        "service",
  ...
  [
    "ROS Setpoint Topics",
    "ROS topics you publish to when controlling the drone from ROS. Use /DRONE_NS when the bridge is launched with a namespace such as /mini1.",
    [
      [
        ...
        'ros2 topic pub /DRONE_NS/mavros/setpoint_position/local geometry_msgs/msg/PoseStamped "{pose: {position: {x: 5.0, y: 0.0, z: 20.0}}}"',
      ...
      [
        ...
        'ros2 topic pub /DRONE_NS/mavros/setpoint_position/global sensor_msgs/msg/NavSatFix "{latitude: 55.6761, longitude: 12.5683, altitude: 35.0}"',
        "Direct GPS waypoint in decimal degrees and meters.",
      ],
      [
        "Velocity Setpoint",
        "topic",
        ...
        'ros2 topic pub /DRONE_NS/mavros/setpoint_velocity/cmd_vel geometry_msgs/msg/TwistStamped "{twist: {linear: {x: 1.0, y: 0.0, z: 0.0}, angular: {z: 0.1}}}"',
        "Velocity command mapped to virtual stick. Enable offboard/virtual stick first.",
      ],
      [
        "Attitude/Gimbal Setpoint",
        "topic",
        "/mavros/setpoint_attitude/attitude",
        "geometry_msgs/msg/PoseStamped",
        'ros2 topic pub /DRONE_NS/mavros/setpoint_attitude/attitude geometry_msgs/msg/PoseStamped "{pose: {orientation: {w: 1.0}}}"',
        "Used by the bridge as a gimbal/attitude command path; pitch is extracted for gimbal control.",
      ],
    ],
  ],
  [
    "ROS Telemetry Topics",
    "Topics published by the bridge from phone telemetry. These are not commands, but they are what downstream ROS nodes should subscribe to for state.",
    [
      [
        "Connection State",
        "topic",
        ...
        "std_msgs/msg/Bool",
        "ros2 topic echo /DRONE_NS/mavros/state/connected",
        "True when the bridge believes the phone/drone interface is connected.",
      ],
      [
        "Mode",
        "topic",
        "/mavros/state/mode",
        "std_msgs/msg/String",
        "ros2 topic echo /DRONE_NS/mavros/state/mode",
        "PX4/MAVROS-style mode translated from DJI flight mode.",
      ],
      [
        "Global Position",
        "topic",
        ...
        "sensor_msgs/msg/NavSatFix",
        "ros2 topic echo /DRONE_NS/mavros/global_position/global",
        "GPS latitude, longitude, and altitude from phone telemetry.",
      ],
      [
        "Local Pose",
        "topic",
        ...
        "geometry_msgs/msg/PoseStamped",
        "ros2 topic echo /DRONE_NS/mavros/local_position/pose",
        "Flat-earth local pose relative to the home location.",
      ],
      [
        "Battery",
        "topic",
        ...
        "ros2 topic echo /DRONE_NS/mavros/battery",
...
class WhepPlayer {
  constructor(drone, tile, options = {}) {
    ...
    this.video.addEventListener("error", () => {
      this.decodeErrors += 1;
      this.report("video_error", {
        error: this.video.error?.message || this.video.error?.code || "unknown",
      });
    });
    this.video.addEventListener("stalled", () =>
      this.report("video_stalled_event"),
    );
  ...
  async connect() {
    ...
    try {
      ...
      this.applyReceiverBufferTarget(
      ...
      this.pc.onconnectionstatechange = () => {
        ...
        this.setStatus(
          state,
          state === "connected" ? "status-good" : "status-warn",
        );
      ...
      this.latestSdpRecovery = summarizeSdpRecovery(
      ...
      this.report("whep_answer_set", {
        url: whepUrl,
        recovery: this.latestSdpRecovery.summary,
      });
      this.startStats();
    } catch (error) {
  ...
  applyReceiverBufferTarget(receiver = null, reason = "update") {
    ...
    for (const activeReceiver of receivers) {
      ...
      try {
        ...
        this.report("receiver_jitter_target_error", {
          error: error.message,
          targetMs: this.receiverBufferTargetMs,
          reason,
        });
      }
    }
    if (supported) {
      ...
      this.receiverBufferAppliedMs = this.receiverBufferTargetMs;
      if (changed)
        this.report("receiver_jitter_target_set", {
          targetMs: this.receiverBufferTargetMs,
          reason,
        });
    }
  ...
  async collectStats() {
    ...
    const bitrateKbps =
      this.lastBytesReceived > 0
        ? ((bytesReceived - this.lastBytesReceived) * 8) / seconds / 1000
        : 0;
    ...
    const payload = {
      ...
      totalFreezesDuration: Number(
        (inbound.totalFreezesDuration || 0).toFixed(3),
      ),
      bytesReceived,
    ...
    if (selectedDroneName === this.drone.name)
      updateModalForDrone(this.drone.name);
  ...
  updateStats(stats) {
    ...
    setText(
      this.tile,
      '[data-stat="jitterBufferTarget"]',
      stats.jitterBufferSupported ? `${stats.jitterBufferTargetMs}ms` : "n/a",
    );
  ...
  computeJitterBufferMetrics(inbound) {
    ...
    const emittedDelta = Math.max(
      0,
      emittedCount - this.lastJitterBufferEmittedCount,
    );
    ...
    const delayMs =
      emittedDelta > 0
        ? Number(((delayDelta / emittedDelta) * 1000).toFixed(1))
        : null;
  ...
  adaptReceiverBuffer(metrics) {
    ...
    const dropDelta = Math.max(
      0,
      metrics.framesDropped - this.lastFramesDropped,
    );
    ...
    const latePressure =
      ...
      dropDelta > 0 ||
      freezeDelta > 0 ||
      jitterMs > this.receiverBufferTargetMs * 0.8;
    if (latePressure) {
      this.receiverStableSince = now;
      const nextTarget = Math.min(
        receiverBufferPolicy.maxMs,
        this.receiverBufferTargetMs + receiverBufferPolicy.stepMs,
      );
    ...
    if (now - this.receiverStableSince < receiverBufferPolicy.stableAfterMs)
      return;
    const nextTarget = Math.max(
      receiverBufferPolicy.minMs,
      this.receiverBufferTargetMs - receiverBufferPolicy.stepMs,
    );
    if (nextTarget !== this.receiverBufferTargetMs) {
      this.receiverBufferTargetMs = nextTarget;
...
function summarizeSdpRecovery(localSdp, remoteSdp) {
  ...
  const health = !remoteSdp
    ? "pending"
    : negotiated.nack && (negotiated.pli || negotiated.fir)
      ? negotiated.rtx
        ? "strong"
        : "usable"
      : "weak";
  return {
    health,
    summary: remoteSdp
      ? `${health}; ${missing.length ? `missing ${missing.join(", ")}` : "NACK/PLI/FIR/RTX present"}`
      : "waiting for WHEP answer",
    negotiated,
    local,
    remote,
  };
...
function parseSdpRecovery(sdp) {
  ...
  for (const payloadType of result.h264PayloadTypes) {
    ...
    if (profile && !result.h264Profiles.includes(profile))
      result.h264Profiles.push(profile);
    if (packetization && !result.h264PacketizationModes.includes(packetization))
      result.h264PacketizationModes.push(packetization);
  }
  return result;
}
...
function render(state) {
  latestState = state;
  const connected = state.drones.filter(
    (drone) => drone.telemetryConnected,
  ).length;
  const discovered = state.drones.filter(
    (drone) => drone.lastDiscoveryAt,
  ).length;
  const readyStreams = state.drones.filter(
    (drone) => drone.mediaMtx?.ready,
  ).length;
  const browserConnections = state.drones.filter(
    (drone) => drone.browserStats?.connectionState === "connected",
  ).length;
...
function renderVideoTiles(state) {
  for (const drone of state.drones) {
    ...
    if (drone.ignored) {
      ...
      drone.mediaMtx?.ready &&
      !player.isConnecting &&
      player.pc?.connectionState !== "connected"
    ) {
      player.connect();
    } else if (
      !drone.mediaMtx?.ready &&
      ...
      if (lostMessage) {
        ...
        player.setStatus(
          ...
          drone.telemetryConnected ? "status-warn" : "status-bad",
        );
      }
    }
  }
...
function createHealthCard(name) {
  ...
  return {
    ...
    pills: element.querySelector('[data-role="pills"]'),
    health: element.querySelector('[data-role="health"]'),
    metrics: element.querySelector('[data-role="metrics"]'),
  };
}
...
function updateHealthCard(card, drone) {
  ...
  card.pills.replaceChildren(
    ...
    makePill(
      drone.telemetryConnected ? "telemetry ok" : "telemetry down",
      drone.telemetryConnected ? "good" : "bad",
    ),
    makePill(
      media.ready ? "stream ready" : "stream wait",
      media.ready ? "good" : "warn",
    ),
    makePill(
      browser.connectionState || "browser idle",
      browser.connectionState === "connected" ? "good" : "warn",
    ),
    makePill(
      drone.ignored ? "ignored" : "active",
      drone.ignored ? "warn" : "good",
    ),
  );
  ...
  updateDetailList(card.metrics, [
    [
      "wifi",
      "Wi-Fi RSSI",
      phone.wifiRssi === undefined ? "-" : `${phone.wifiRssi} dBm`,
    ],
    [
      "phoneBattery",
      "Phone Battery",
      phone.battery === undefined ? "-" : `${phone.battery}%`,
    ],
    [
      "senderFps",
      "Sender FPS",
      sender.outputFps === undefined
        ? "-"
        : `${Number(sender.outputFps).toFixed(1)} / ${sender.targetFps || "-"}`,
    ],
    [
      "senderProcessing",
      "Sender Processing",
      sender.averageFrameProcessingMs === undefined
        ? "-"
        : `${Number(sender.averageFrameProcessingMs).toFixed(1)} ms/frame`,
    ],
    [
      "browserFps",
      "Browser FPS",
      browser.fps === undefined ? "-" : Number(browser.fps).toFixed(1),
    ],
    [
      "bitrate",
      "Bitrate",
      browser.bitrateKbps === undefined ? "-" : `${browser.bitrateKbps} kbps`,
    ],
    [
      "loss",
      "Loss / Drop",
      `${browser.packetsLost ?? "-"} / ${browser.framesDropped ?? "-"}`,
    ],
    [
      "recentLoss",
      "Recent Loss / Drop",
      trend.ready ? `${trend.lostDelta} / ${trend.dropDelta}` : "-",
    ],
    [
      "jitter",
      "Jitter",
      browser.jitter === undefined
        ? "-"
        : `${Number(browser.jitter * 1000).toFixed(0)} ms`,
    ],
...
function updateHealthTrend(drone) {
  ...
  const current = {
    ...
    packetsLost: hasBrowserStats
      ? Number(browser.packetsLost || 0)
      : Number(previous?.packetsLost || 0),
    framesDropped: hasBrowserStats
      ? Number(browser.framesDropped || 0)
      : Number(previous?.framesDropped || 0),
    freezeCount: hasBrowserStats
      ? Number(browser.freezeCount || 0)
      : Number(previous?.freezeCount || 0),
  };
  if (!previous) {
    const initialTrend = {
      ready: false,
    ...
    healthTrendState.set(drone.name, {
      ...current,
      at: now,
...
function createTelemetryCard(name) {
  ...
  return {
    ...
    subtitle: element.querySelector('[data-role="subtitle"]'),
    pills: element.querySelector('[data-role="pills"]'),
    tree: element.querySelector('[data-role="tree"]'),
    treeState: new Map(),
  };
}
...
function updateTelemetryCard(card, drone) {
  ...
  updateText(
    card.subtitle,
    `${drone.ip || "no ip"} | telemetry ${drone.telemetryConnected ? "ok" : "down"} | ${telemetryAgeLabel(drone)}`,
  );
  card.pills.replaceChildren(
    makePill(
      drone.telemetryConnected ? "telemetry ok" : "telemetry down",
    ...
    makePill(
      drone.browserStats?.connectionState || "browser idle",
      drone.browserStats?.connectionState === "connected" ? "good" : "warn",
    ),
    makePill(
      drone.ignored ? "ignored" : "active",
      drone.ignored ? "warn" : "good",
...
function rememberTreeState(card) {
  card.tree
    .querySelectorAll("details.treeNode[data-tree-path]")
    .forEach((details) => {
...
function renderPublishTargets(state) {
  ...
  for (const drone of state.drones) {
    ...
    card
      .querySelector(".targetPills")
      .append(
        makePill(
          drone.ip ? "reachable IP" : "no IP",
          drone.ip ? "good" : "warn",
        ),
        makePill(
          drone.ignored ? "ignored" : "armed for test",
          drone.ignored ? "warn" : "good",
        ),
      );
...
function renderHttpPublishCatalog() {
  for (const [groupTitle, description, commands] of publishCatalog) {
    ...
    for (const [
      ...
      const requestLine =
        method === "GET"
          ? `${method} http://DRONE_IP:8080${endpoint}`
...
function renderHealthSummary(root, health) {
  ...
  const issues = health.issues.length
    ...
    : [
        {
          label: "No active symptom detected",
          tone: "good",
          detail: health.primary,
        },
      ];
...
function buildDroneHealth(
  ...
  const addIssue = (label, tone, detail) =>
    issues.push({ label, tone, detail });
  ...
  if (!drone.telemetryConnected)
    addIssue(
      "Telemetry down",
      "bad",
      "Phone telemetry socket is not producing samples.",
    );
  if (
    drone.telemetryConnected &&
    !media.ready &&
    (drone.telemetryPackets || 0) > 20
  )
    addIssue(
      "Stream not ready",
      "bad",
      "Telemetry is alive but MediaMTX has no ready video path.",
    );
  if (Number.isFinite(wifiRssi)) {
    if (wifiRssi <= -78)
      addIssue(
        "Wi-Fi weak",
        "bad",
        `${wifiRssi} dBm can produce loss and jitter.`,
      );
    else if (wifiRssi <= -67)
      addIssue(
        "Wi-Fi marginal",
        "warn",
        `${wifiRssi} dBm leaves limited airtime margin.`,
      );
  }
  if (Number.isFinite(phoneBattery) && phoneBattery >= 0) {
    if (phoneBattery <= 15)
      addIssue(
        "Phone battery low",
        "bad",
        `${phoneBattery}% may trigger thermal or power limits.`,
      );
    else if (phoneBattery <= 30)
      addIssue("Phone battery watch", "warn", `${phoneBattery}% remaining.`);
  }
  if (senderTargetFps > 0) {
    const frameBudgetMs = 1000 / senderTargetFps;
    if (senderOutputFps > 0 && senderOutputFps < senderTargetFps * 0.55)
      addIssue(
        "Sender FPS low",
        "bad",
        `Phone output ${senderOutputFps.toFixed(1)} / ${senderTargetFps} fps.`,
      );
    else if (senderInputFps > 0 && senderOutputFps < senderInputFps * 0.65)
      addIssue(
        "Sender dropping frames",
        "warn",
        `Input ${senderInputFps.toFixed(1)} fps, output ${senderOutputFps.toFixed(1)} fps.`,
      );
    if (senderProcessingMs >= frameBudgetMs * 0.9)
      addIssue(
        "Encoder pipeline saturated",
        "bad",
        `${senderProcessingMs.toFixed(1)} ms/frame near ${frameBudgetMs.toFixed(1)} ms budget.`,
      );
    else if (senderProcessingMs >= frameBudgetMs * 0.7)
      addIssue(
        "Encoder pipeline hot",
        "warn",
        `${senderProcessingMs.toFixed(1)} ms/frame resize/processing.`,
      );
  }
  if (browser.connectionState === "connected") {
    if (
      senderOutputFps > 2 &&
      browserFps > 0 &&
      browserFps < senderOutputFps * 0.55
    )
      addIssue(
        "Browser decode lag",
        "bad",
        `Browser ${browserFps.toFixed(1)} fps while sender outputs ${senderOutputFps.toFixed(1)} fps.`,
      );
    else if (media.ready && framesDecoded > 0 && browserFps <= 1)
      addIssue(
        "Browser video stalled",
        "bad",
        `Browser is connected but decoding only ${browserFps.toFixed(1)} fps.`,
      );
    else if (media.ready && browserBitrateKbps > 0 && browserBitrateKbps < 80)
      addIssue(
        "Browser bitrate low",
        "warn",
        `Receiving ${browserBitrateKbps.toFixed(0)} kbps from a ready H264 stream.`,
      );
    if (browserJitterMs >= 150)
      addIssue(
        "Browser jitter high",
        "bad",
        `${browserJitterMs.toFixed(0)} ms RTP jitter.`,
      );
    else if (browserJitterMs >= 60)
      addIssue(
        "Browser jitter elevated",
        "warn",
        `${browserJitterMs.toFixed(0)} ms RTP jitter.`,
      );
    if (recentLoss > 0)
      addIssue(
        "Packet loss active",
        recentLoss > 20 ? "bad" : "warn",
        `${recentLoss} new lost packets; ${packetsLost} cumulative.`,
      );
    if (recentDrops > 0)
      addIssue(
        "Frame drops active",
        recentDrops > 10 ? "bad" : "warn",
        `${recentDrops} new dropped frames; ${framesDropped} cumulative.`,
      );
    if (recentFreezes > 0)
      addIssue(
        "Receiver freezes active",
        recentFreezes > 2 ? "bad" : "warn",
        `${recentFreezes} new freeze events; ${freezes} cumulative.`,
      );
  }
  if (recentInboundErrors > 0)
    addIssue(
      "MediaMTX frame errors active",
      recentInboundErrors > 5 ? "bad" : "warn",
      `${recentInboundErrors} new inbound frame errors; ${inboundErrors} cumulative.`,
    );
  if (browser.sdpRecovery) {
    if (!recovery.nack)
      addIssue(
        "NACK missing",
        "warn",
        "Negotiated SDP does not advertise generic NACK.",
      );
    if (!recovery.pli && !recovery.fir)
      addIssue(
        "Keyframe request weak",
        "warn",
        "Negotiated SDP lacks PLI/FIR feedback.",
      );
    if (!recovery.rtx)
      addIssue(
        "RTX missing",
        "warn",
        "Retransmission payloads were not negotiated.",
      );
  }

  const worstTone = issues.some((issue) => issue.tone === "bad")
    ? "bad"
    : issues.some((issue) => issue.tone === "warn")
      ? "warn"
      : "good";
  const label =
    worstTone === "good"
  ...
  const primary =
    issues[0]?.detail ||
    "Telemetry, stream, sender, browser, and recovery indicators look nominal.";
...
function updateTelemetryStats(tile, drone) {
  ...
  setText(
    tile,
    '[data-stat="telemetry"]',
    drone.telemetryConnected ? "ok" : "down",
  );
  updateClass(
    tile.querySelector('[data-stat="telemetry"]'),
    drone.telemetryConnected ? "status-good" : "status-bad",
  );
  setText(
    tile,
    '[data-stat="mediaMtx"]',
    media.ready ? `${media.readers?.length || 0}` : "wait",
  );
  updateClass(
    tile.querySelector('[data-stat="mediaMtx"]'),
    media.ready ? "status-good" : "status-warn",
  );
}

function droneColor(name) {
  const index =
    latestState?.drones.findIndex((drone) => drone.name === name) ?? 0;
...
function updateTelemetryChartSamples(state) {
  for (const drone of state.drones) {
    ...
    const phone = telemetry.phoneLocation || {};
    const previous = telemetryRateState.get(drone.name) || {
...
function ensureCharts(groupName) {
  ...
  if (!window.LightweightCharts) {
    chartsGrid.innerHTML =
      '<div class="emptyState">Charts are unavailable because Lightweight Charts did not load. Check network access to the CDN.</div>';
    return false;
  }
  for (const definition of group.definitions) {
    ...
    const chart = window.LightweightCharts.createChart(
      card.querySelector(".chartCanvas"),
      {
        autoSize: true,
        layout: { background: { color: "#1a1d20" }, textColor: "#edf1f4" },
        grid: {
          vertLines: { color: "#2b3137" },
          horzLines: { color: "#2b3137" },
        },
        timeScale: {
          timeVisible: true,
          secondsVisible: true,
...
function updateCharts(groupName = null) {
  const groups = groupName
    ? [groupName]
    : Object.keys(chartGroups).filter((name) =>
        document
...
function restoreModalVideo() {
  ...
  modalMountedPlayer.tile.insertBefore(
    modalMountedPlayer.videoWrap,
    modalReturnAnchor,
  );
...
function updateModalForDrone(name) {
  ...
  const media = drone.mediaMtx || {};
  const browserStats =
    modalMountedPlayer?.latestStats || drone.browserStats || {};
  const recovery = browserStats.sdpRecovery || emptySdpRecovery();
  const negotiatedRecovery = recovery.negotiated || {};
  const health = buildDroneHealth(
    drone,
    healthTrendState.get(drone.name)?.lastTrend,
  );
  const lostMessage = cameraLostMessage(drone);
  const speed = telemetry.speed || {};
  ...
  updateText(
    modalSubtitle,
    `${drone.ip || "no ip"} | ${drone.ignored ? "ignored" : "active"} | telemetry ${drone.telemetryConnected ? "ok" : "down"} | stream ${media.ready ? "ready" : "waiting"}`,
  );
  updateDetailList(modalTelemetry, [
    [
      ...
      "Telemetry",
      drone.telemetryConnected
        ? `ok (${telemetryAgeLabel(drone)})`
        : `down (${telemetryAgeLabel(drone)})`,
      drone.telemetryConnected ? "status-good" : "status-bad",
    ],
    ...
    [
      ...
      "Location",
      telemetry.location
        ? `${telemetry.location.latitude}, ${telemetry.location.longitude}, ${telemetry.location.altitude}m`
        : "-",
    ],
    [
      "speed",
      "Speed",
      Number.isFinite(magnitude(speed.x, speed.y, speed.z))
        ? `${magnitude(speed.x, speed.y, speed.z).toFixed(2)} m/s`
        : "-",
    ],
    [
      "phoneBattery",
      "Phone Battery",
      telemetry.phoneLocation?.battery === undefined
        ? "-"
        : `${telemetry.phoneLocation.battery}%`,
    ],
  ...
  updateDetailList(modalStats, [
    ...
    [
      "healthPrimary",
      "Primary Symptom",
      health.issues[0]?.label || "No active symptom",
    ],
    [
      "mediamtx",
      "MediaMTX",
      media.ready ? `ready (${media.readers?.length || 0} readers)` : "waiting",
      media.ready ? "status-good" : "status-warn",
    ],
    ...
    [
      "fps",
      "FPS",
      browserStats.fps === undefined
        ? "-"
        : Number(browserStats.fps).toFixed(1),
    ],
    [
      "bitrate",
      "Receive Bitrate",
      browserStats.bitrateKbps === undefined
        ? "-"
        : `${browserStats.bitrateKbps} kbps`,
    ],
    ...
    [
      "receiverPolicy",
      "Receiver Policy",
      browserStats.receiverBufferPolicy || "-",
    ],
    [
      "jitterTarget",
      "Jitter Target",
      browserStats.jitterBufferSupported
        ? `${browserStats.jitterBufferTargetMs} ms`
        : "not supported",
    ],
    [
      "jitterDelay",
      "Jitter Delay",
      browserStats.jitterBufferDelayMs === null ||
      browserStats.jitterBufferDelayMs === undefined
        ? "-"
        : `${browserStats.jitterBufferDelayMs} ms/frame`,
    ],
  ...
  updateDetailList(modalRecovery, [
    ...
    [
      "nack",
      "NACK Negotiated",
      negotiatedRecovery.nack ? "yes" : "no",
      negotiatedRecovery.nack ? "status-good" : "status-warn",
    ],
    [
      "pli",
      "PLI Negotiated",
      negotiatedRecovery.pli ? "yes" : "no",
      negotiatedRecovery.pli ? "status-good" : "status-warn",
    ],
    [
      "fir",
      "FIR Negotiated",
      negotiatedRecovery.fir ? "yes" : "no",
      negotiatedRecovery.fir ? "status-good" : "status-warn",
    ],
    [
      "rtx",
      "RTX Negotiated",
      negotiatedRecovery.rtx ? "yes" : "no",
      negotiatedRecovery.rtx ? "status-good" : "status-warn",
    ],
    [
      "h264Profile",
      "H264 Profile",
      negotiatedRecovery.h264Profiles?.join(", ") ||
        browserStats.codecFmtpLine ||
        "-",
    ],
    [
      "packetization",
      "Packetization",
      negotiatedRecovery.h264PacketizationModes?.join(", ") || "-",
    ],
    ...
    [
      "codecStats",
      "Browser Codec",
      browserStats.codecMimeType
        ? `${browserStats.codecMimeType} pt=${browserStats.codecPayloadType ?? "-"}`
        : "-",
    ],
  ]);
  if (drone.ignored) modalMountedPlayer?.setStatus("ignored", "status-warn");
    ...
    !media.ready &&
    modalMountedPlayer?.pc?.connectionState !== "connected"
  ) {
    modalMountedPlayer?.setStatus(
      drone.telemetryConnected ? "waiting for stream" : "waiting for telemetry",
      drone.telemetryConnected ? "status-warn" : "status-bad",
    );
  }
}
...
function telemetryAgeLabel(drone) {
  return drone.lastTelemetryAt
    ? `${Math.max(0, Math.round((Date.now() - Date.parse(drone.lastTelemetryAt)) / 1000))}s ago`
    : "no sample yet";
}
